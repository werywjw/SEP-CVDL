...
\definecolor{LMUGrey1}{HTML}{E6E6E7}
\definecolor{LMUGrey2}{HTML}{C0C1C3}
\definecolor{LMUGrey3}{HTML}{626468}
...
\author{Jiawen Wang$^\dagger$ $^\star$\\ % $^\heartsuit$ 
...
% {\tt\small\{Jiawen.Wang,Leah.Kawka\}@campus.lmu.de}\\
}
