...
\begin{itemize}
  ...
  \item \textbf{Leah Kawka} collected the databases, prepared data processing, provided sever with databases, implemented augmentation and evaluating video/webcam script. 
  She helps run the results with Slurm, (and takes part in the explainable AI) % implemented landmarks, heatmap-Overlay, detected emotions visualization.

  In the specific writing part, 
  she also writes the related parts and drew the \Cref{fig:pipeline}. and took part in Dataset figure
