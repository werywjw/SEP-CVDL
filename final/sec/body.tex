...
To plot Landmarks on each video frame, we implemented the dlib face detector shape_predictor_68_face_landmarks.dat % \texttt{shape_predictor_68_face_landmarks.dat}, 
