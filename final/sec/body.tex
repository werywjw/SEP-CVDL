...
\begin{itemize}
  \item We collect and preprocess the training image and video data from various public databases. 
  \item We implement several CNN models from scratch and optimize it with different augmentation techniques. 
  \item We explain the model with CAM and Grad-CAM.
\end{itemize}
...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lcccc@{}}
    \toprule 
    Models &  Accuracy (Train) &  Accuracy (Test) & Accuracy (Vali) & \# params \\
    \midrule
