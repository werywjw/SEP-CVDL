...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lccc@{}}
    ...
    Extended Cohn-Kanade Dataset Plus (CK+~\cite{LuceyCKSAM10}) & (replace number here) &-& 600 \\
    Taiwanese Facial Expression Image Database (TFEID~\cite{tfeid,LiGL22}) & (replace number here) &-& 600 \\
    \bottomrule
  \end{tabular}
  }
