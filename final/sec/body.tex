...
augmentation, creating Tensors and normalization. 
...
To evaluate videos we extract every frame and crop the area (rectangle) of interest for detect emotions.
The cropped imaged 
wrote is beeing cropped in the detect emotion function and beeing evaluated through  

this also works for live web cam
