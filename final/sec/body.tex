...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        ...
        symbolic x coords={VGG,ResNet18,ResNet34,Baseline,GiMeFive},
    ...
    \addplot[fill=Pink!30] coordinates {(VGG,83.3)};
    \addlegendentry{VGG}
...
The test accuracy on the RAF-DB dataset is shown in \Cref{fig:acc}. 
...
Also, % stabilize the learning process and
...
but also inspired a plethora of subsequent research efforts for informative facial feature detections. % aimed at enhancing network architectures
...
Again, illustrated in \Cref{fig:video}, 
happiness emotions (see \Cref{{fig:v1}}) are the easiest to detect in principle. 
...
% with 15 layers and 10478086 parameters 
In addition, 
