...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lccccc@{}}
    \toprule 
    Models & Architecture & Training Accuracy & Testing Accuracy & Validation Accuracy  & \# Parameters \\
    \midrule
    CNN (4 layers) & +BN-SE & 96.6 & 80.6 & 66.8 & 2606086 \\ % RAF-DB add dataset at the very begining coloumn
    ...
    CNN (6 layers) & +BN-SE & 97.5 & 82.5 & 70.0 & 41950726 \\ % RAF-DB
    \midrule
    CNN (4 layers) & +BN-SE & 86.6 & 64.1 & 40.2 & 2606086 \\ % FER
    CNN (5 layers) & +BN-SE & 89.6 & 65.6 & 40.7 & 10478086 \\ % FER
    CNN (6 layers) & +BN-SE & 96.0 & 65.5 & 41.6 & 41950726 \\ % FER
    \bottomrule
  \end{tabular}
  % }
