...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}llccccr@{}}
    ...
    \midrule
    \multirow{3}{*}{FER2013~\cite{BarsoumZCZ16}} & CNN (4 layers) & +BN-SE & 86.6 & 64.1 & 40.2 & 2606086 \\
...
\Cref{fig:model} shows the test result aggregated from the database RAF-DB~\cite{kaggle_rafdb} and FER2013~\cite{kaggle_fer}.
