...
\begin{table}%[ht]
  ...
  \begin{tabular}{@{}lcccc@{}}
    \toprule
    Dataset & # Images in training set & # Images in training set & # Images in training set & Accuracy \\
    \midrule
    RAF-DB & 9747 & 2388 & 600 & \\
    FER+ & 23743 & 5945 & 600 & \\
    \bottomrule
  \end{tabular}
  \caption{Overview of the datasets used in our experiment}
  \label{tab:hyper}
\end{table}
...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lccccc@{}}
    ...
    ResNet18~\cite{HeZRS16} & & 98.9 & 81.3 & 67.9 & 11179590 \\
