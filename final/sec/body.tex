...
\begin{figure}[ht]
  ...
  \caption{Overview of the detailed model architecture} 
...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}llccccc@{}}
    \toprule 
    \textsc{Dataset} & \textsc{Models} & \textsc{Architecture} & \textsc{Training Accuracy} & \textsc{Testing Accuracy} & \textsc{Validation Accuracy}  & \textsc{\# Parameters} \\
    \midrule
    \multirow{6}{*}{RAF-DB~\cite{li_reliable_2017,li2019reliable}}     & ResNet18~\cite{HeZRS16} & Res & 98.9 & 81.3 & 67.9 & 11179590 \\
    ...
    &CNN (6 layers) & +BN-SE & 96.0 & 65.5 & 41.6 & 41950726 \\
    \bottomrule
  \end{tabular}
  }
  \caption{Accuracies (\%) for different models in our experiments 
  (Note that SE stands for squeeze and excitation, BN for batch normalization, and Res for residual connections; 
