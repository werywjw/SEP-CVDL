...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.47\linewidth}
    ...
    \label{fig:xai6}
  \end{subfigure}
  \caption{Examples of XAI images with all six facial emotional classes (left: original image; middle: heatmap; right: Grad-CAM overlayed image) on the validation set.}
  \label{fig:xai}
\end{figure}
