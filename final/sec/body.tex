...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lccc@{}}
    ...
    FER AffectNet Database (FER AffectNet~\cite{Mollah2019ANet}) & 21045 &-& 600  \\
    ...
    \midrule
    \midrule
    FER \textsc{GiMeFive} & 55073 & 8333 & 600 \\
    \bottomrule
  \end{tabular}
  }
...
% % tabel of labeled training images !! not the right size yet !!
% \begin{table*}[ht]
%   \centering
%   \resizebox{\textwidth}{!}{
%   \begin{tabular}{@{}lccc@{}}
%       \toprule
%       \textsc{Numbers of emotion labeled Images} & \#happiness & \#surprise & \#sadness & \#anger & \#disgust & \#fear \\
%       \midrule
...
%       \midrule
%       \midrule
%       FER \textsc{GiMeFive} & 15187 & 8619 & 11923 & 7996 & 3729 & 7619 \\
%       \bottomrule
%   \end{tabular}
%   }
% \caption{Overview of statistics of labeled Images for Training used in our experiment}
% \label{tab:data}
% \end{table*}
