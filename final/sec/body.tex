...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \addplot[fill=Pink!30] coordinates {(VGG16,90)};
    % \addplot[fill=Pink!50] coordinates {(VGG16,88)};
    % \addlegendentry{VGG16 Test}
    \addlegendentry{VGG16}

    \addplot[fill=LightPurple!30] coordinates {(ResNet18,85)};
    % \addplot[fill=LightPurple!50] coordinates {(ResNet18,82)};
    % \addlegendentry{ResNet18 Test}
    \addlegendentry{ResNet18}

    \addplot[fill=cvprblue!30] coordinates {(ResNet50,88)};
    % \addplot[fill=cvprblue!50] coordinates {(ResNet50,85)};
    % \addlegendentry{ResNet50 Test}
    \addlegendentry{ResNet50}

    \addplot[fill=Orange!30] coordinates {(Basline,92)};
    % \addplot[fill=Orange!50] coordinates {(Basline,90)};
    % \addlegendentry{Basline Test}
    \addlegendentry{Basline}

    \addplot[fill=LMUGreen!30] coordinates {(GiMeFive,87)};
    % \addplot[fill=LMUGreen!50] coordinates {(GiMeFive,85)};
