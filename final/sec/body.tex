...
Detailed information of emotion classification - See \Cref{sec:evaluation:inter} % \paragraph{Video.} ?? is video right?
...
\texttt{shape_predictor_68_face_landmarks.dat}, constructed using the classic Histogram of Oriented Gradients feature
(HOG)~\cite{1467360} combined with a linear classifier, an image pyramid, and sliding window detection scheme.~\cite{dlib_site}
