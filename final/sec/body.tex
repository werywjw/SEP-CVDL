...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lccc@{}}
    ...
    Fer Affectnet Database (Fer Affectnet~\cite{kagaff, Mollah2019ANet}) & 21045 &-& 600  \\
    Extended Cohn-Kanade Dataset Plus (CK+~\cite{LuceyCKSAM10}) & 309 &-& 600 \\
    Taiwanese Facial Expression Image Database (TFEID~\cite{tfeid,LiGL22}) & 229 &-& 600 \\
    \bottomrule
  \end{tabular}
  }
...
\begin{itemize}
  ...
  training and testing infrastructure, classification score script, Grad-CAM explaination, and optimization strategies, 
  together with the corresponding writing part. 
  % Also, she is responsible for the figures and tables of this report.
  \item \textbf{Leah Kawka} collected the training data, prepared data processing, implemented augmentation. 
...
We specially acknowledge our former team member \textbf{Tanja Jaschkowitz}, 
who joined us during the first phase of the project and shared two scripts.
