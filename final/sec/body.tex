...
\textit{convolutional neural networks} (CNNs) \Cref{sec:setup:model}, listed in \Cref{fig:acc}, to detect and interpret six basic universally recognized and expressed human facial emotions (i.e., happiness, surprise, sadness, anger, disgust, and fear).
...
% we exp\lain this emotion classification task with \textit{gradient-weighted class activation mapping} 
...
\begin{itemize}
  \item We collected Datasets \Cref{sec:setup:datasets}, preprocessed images or videos Cite: preprocessing image/video, and evaluated (Cite: Evaluation) the training and testing data (Cite: figure 4, 8) thoroughly from various 
...
The experimental pipeline is outlined in cite Figure 2.
\begin{figure}[ht]
  \centering
