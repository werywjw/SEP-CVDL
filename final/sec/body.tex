...
\begin{figure}[ht]
  ...
  \caption{Test accuracies of our \textsc{GiMeFive} compared to other state-of-the-art models on the RAF-DB dataset.} 
  \label{fig:acc}
\end{figure}
...
Studies of the kaleidoscope of human emotions have been a central pursuit in psychology for centuries. 
