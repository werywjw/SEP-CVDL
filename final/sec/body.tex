...
\Cref{fig:model} illustrates the empirical results of our current best model. 
...
\Cref{fig:model} shows the test result aggregated from the database RAF-DB~\footnote{\url{https://www.kaggle.com/datasets/shuvoalok/raf-db-dataset}}. 
