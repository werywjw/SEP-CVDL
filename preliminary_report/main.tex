...
\input{sec/1_intro}    
\input{sec/2_research}
\input{sec/3_approach} 
\input{sec/4_preliminary_results} 
\input{sec/5_optimisation_strategy} 
\input{sec/6_presentation} 
\input{sec/7_report} 
\input{sec/8_time_schedule} 
\input{sec/9_discussion} 
