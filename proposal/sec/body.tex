...
\begin{figure*}
  \resizebox{\textwidth}{!}{
    \begin{ganttchart}[
      ...
      \ganttbar[bar/.append style={fill=Orange}]{Video Preparing}{2024-01-17}{2024-02-07} \\
      \ganttbar[bar/.append style={fill=Orange}]{Slides Preparing}{2024-01-20}{2024-02-07} \\
...
we convert the images to greyscale with three channels as our original convolutional neutral network (CNN) is designed to work with three-channel inputs. 
...
We also add the residual connections to help the training deeper networks more efficiently, 
...
\begin{itemize}
  ...
  \item \textbf{Mahdi Mohammadi} implemented the , augumentation, 
