...
Occlusion experiments are conducted to assess the model's ability to identify object locations.
The model proves to be sensitive to local structures, as occlusion leads to a significant drop in the probability of the correct class.
